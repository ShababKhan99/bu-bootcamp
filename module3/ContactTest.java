...
public class ContactTest {
    ...
    @Test
    void constructor_sameNameContacts() {
        Contact c = new Contact("Francisco Lindor", "555-0001");
        Contact d = new Contact("Francisco Lindor", "555-9820");
        assertEquals("555-0001", c.getPhone());
    }
}
